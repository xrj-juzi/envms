...
//        $result = $this->executeQuery();
        if ($result) {
            return $this->fluent->getPdo()->lastInsertId();
        }
    ...
    public function executeQuery(){
        ...
        var_dump($params);
        try {
            $this->PDOStatement = $this->fluent->getPdo()->prepare($query);
            var_dump($this->PDOStatement->execute($params));
        }catch (\Exception $e){
            var_dump($e->getMessage());
            var_dump($this->fluent->getPdo()->errorInfo());
